...
1. Clone the repository: `git clone https://github.com/<github-username>/Discriptive-Analysis-cricket-player-stats.git`
2. Run the Jupyter Notebook: `jupyter notebook Player-stats-Analysis.ipynb`
